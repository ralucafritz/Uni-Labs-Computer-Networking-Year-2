...
```
![](https://gcdnb.pbrd.co/images/rbKWFuuhrSao.png?o=1)
...
![](https://gcdnb.pbrd.co/images/iF7M3Iaj5gXg.png?o=1)
...
```
![](https://gcdnb.pbrd.co/images/RpAfDFfGQByp.png?o=1)
...
![](https://gcdnb.pbrd.co/images/0o59xmWLM1V4.png?o=1)

Se vor face si `ping`-uri intre IPv4 Addess-uri(in `DONALD` cu IPv4 `SERVER`):
![](https://gcdnb.pbrd.co/images/jLV45XWTtFkG.png?o=1)

Pentru o verificare a configurarile interface => hover pe `ROUTER`, exemplu:
![](https://gcdnb.pbrd.co/images/zQe4a2W78zk8.png?o=1)
...
- in sectiunea `HTTP`:
  ...
  - exemplu:
![](https://gcdnb.pbrd.co/images/es474Swi2mpA.png?o=1)
...
- in sectiunea `DNS`:
  ...
  - se introduce `<DNS Server IP>` => `209.165.250.46`; (in poza am gresit ip-ul)
![](https://gcdnb.pbrd.co/images/MfwONbsIgTY1.png?o=1)
  - se apasa pe `Add`;
